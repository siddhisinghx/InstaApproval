...
@Component({
  selector: 'app-salesofficer-pending',
  templateUrl: './salesofficer-pending.component.html',
  styleUrls: ['./salesofficer-pending.component.css']
})
export class SalesofficerPendingComponent implements OnInit {
